        ...
        for iShiftRow in range(0, 3):
            for iShiftCol in range(0, 3):
                sXmlRunCells = " ".join([_cell_xml(0, 0, 0, 0, "10,60 20,60 20,70 10,70", bCellContent,
                                                   iShiftRow=iShiftRow, iShiftCol=iShiftCol)
                ...
                sXmlRunCells = " ".join([_cell_xml(0, 0, 0, 0, "10,60 20,60 20,70 10,70", bCellContent,
                                                   iShiftRow=iShiftRow, iShiftCol=iShiftCol)
                                            , _cell_xml(0, 1, 0, 1, "64,60 70,60 70,70 64,70", bCellContent,
                                                        iShiftRow=iShiftRow, iShiftCol=iShiftCol)
                                         ])
                RUN = _rectangle(90, 100, sXmlCells=sXmlRunCells)  # width=90
                res = _strEval(GT, RUN, 0.95)
                ...
                sXmlRunCells = " ".join([_cell_xml(0, 0, 0, 0, "10,60 70,60 70,70 10,70", bCellContent,
                                                   iShiftRow=iShiftRow, iShiftCol=iShiftCol)
                                         ])
                RUN = _rectangle(90, 100, sXmlCells=sXmlRunCells)  # width=90
                res = _strEval(GT, RUN, 0.85)
                ...
                sXmlRunCells = " ".join([_cell_xml(0, 0, 0, 0, "10,60 70,60 70,70 10,70", bCellContent,
                                                   iShiftRow=iShiftRow, iShiftCol=iShiftCol)
                                            , _cell_xml(0, 1, 0, 1, "260,60 270,60 270,70 260,70", bCellContent,
                                                        iShiftRow=iShiftRow, iShiftCol=iShiftCol)
                                         ])
                RUN = _rectangle(90, 100, sXmlCells=sXmlRunCells)  # width=90
                res = _strEval(GT, RUN, 0.85)
    ...
    for iRgt, iCgt in [(i, j) for i in range(6) for j in range(6)]:
        ...
        for iR, iC in [(i, j) for i in range(3) for j in range(3)]:
            ...
            sXmlCells = " ".join([_cell_xml(0, 0, 0, 0, "10,60 20,60 20,70 10,70", iShiftRow=iR, iShiftCol=iC)
                                     ...
                                     , _cell_xml(1, 0, 1, 0, "10,70 20,70 20,76 10,86", iShiftRow=iR, iShiftCol=iC)
                                  # here!
                                  ])
            RUN = _rectangle(100, 100, sXmlCells=sXmlCells)
            res = _strEval(GT, RUN, 0.95)
            ...
            sXmlCells = " ".join([_cell_xml(0, 0, 0, 0, "10,60 20,60 20,70 10,70", iShiftRow=iR, iShiftCol=iC)
                                     , _cell_xml(0, 1, 0, 1, "60,60 70,60 70,66 60,66", iShiftRow=iR, iShiftCol=iC)
                                  # here
            ...
            sXmlCells = " ".join([_cell_xml(0, 0, 0, 0, "10,60 20,60 20,70 10,70", iShiftRow=iRgt, iShiftCol=iCgt)
                                     , _cell_xml(0, 1, 0, 1, "60,60 70,60 70,66 60,66", iShiftRow=iRgt, iShiftCol=iCgt)
                                  # here
                                     , _cell_xml(1, 0, 1, 0, "10,70 20,70 20,76 10,86", iShiftRow=iRgt, iShiftCol=iCgt)
                                  # here
                                     , _cell_xml(1, 1, 1, 1, "30,70 40,70 40,80 50,90", iShiftRow=iRgt, iShiftCol=iCgt)
                                  ])
            RUN = _rectangle(100, 100, sXmlCells=sXmlCells)
...
def test_table_recognition_spanning_cells_simple():
    ...
    for bRotate in [False, True]:
        ...
        sXmlCells = " ".join([_cell_xml(0, 0, 0, 2, "10,60 100,60 100,70 10,70", bRotate=bRotate)
                              # flat horizontal rectangle spanning over 3 cols
        ...
        sXmlCells = " ".join([_cell_xml(0, 0, 0, 2, "10,60 100,60 100,70 10,70", bRotate=bRotate)
                              # flat horizontal rectangle spanning over 3 cols
                                 , _cell_xml(1, 0, 1, 0, "10,80  90,80  90,90 10,90", bRotate=bRotate)
                              # another long flat rectangle
                              ])
        RUN = _rectangle(100, 100, sXmlCells=sXmlCells)
        res = _strEval(GT, RUN, 0.95)
