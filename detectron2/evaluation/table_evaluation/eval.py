...
from table_evaluation.data_structure import *
...
class eval:
    ...
    reg_gt_path = os.path.abspath("./table_evaluation/annotations/trackA/")
    reg_gt_path_archival = os.path.abspath("./table_evaluation/annotations/trackA_archival/")
    reg_gt_path_modern = os.path.abspath("./table_evaluation/annotations/trackA_modern/")
    str_gt_path_1 = os.path.abspath("./table_evaluation/annotations/trackB1/")
    str_gt_path_2 = os.path.abspath("./table_evaluation/annotations/trackB2/")
    str_gt_path_archival = os.path.abspath("./table_evaluation/annotations/trackB2_archival/")
    str_gt_path_modern = os.path.abspath("./table_evaluation/annotations/trackB2_modern/")
